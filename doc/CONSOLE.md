...
- **Status header** showing overall system status (Running, Partial, or Disconnected)
...
The status header shows:
- **Running** — all configured servers are active and connected
- **Partial** — some servers are connected, some are not
- **Disconnected** — no servers are connected
...
- **Status shows "Disconnected" but servers are active?**
